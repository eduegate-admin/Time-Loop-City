...
namespace TimeLoopCity.World
{
    ...
    public class WorldStateManager : MonoBehaviour
    {
        ...
        {
            // Apply weather
            World.WeatherSystem weatherSystem = FindFirstObjectByType<World.WeatherSystem>();
            ...
            // Apply time of day
            World.TimeOfDaySystem timeSystem = FindFirstObjectByType<World.TimeOfDaySystem>();
            if (timeSystem != null)
            {
